...
export class IndexComponent implements OnInit {
  ...
  total = 0;
  data: CatalogItemDto[] = [];
  columns: string[] = ['name', 'level', 'parentId', 'createdTime', 'updatedTime', 'actions'];
  dataSource!: MatTableDataSource<CatalogItemDto>;
    ...
    this.service.filter(this.filter)
      .subscribe(res => {
        if (res.data) {
          ...
          this.dataSource = new MatTableDataSource<CatalogItemDto>(this.data);
        }
        this.isLoading = false;
      });
  }

  deleteConfirm(item: CatalogItemDto): void {
