...
public class EntityMemberConstraintManager : DomainManagerBase<EntityMemberConstraint, EntityMemberConstraintUpdateDto, EntityMemberConstraintFilterDto, EntityMemberConstraintItemDto>, IEntityMemberConstraintManager
{
