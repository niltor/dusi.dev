...
/// 目录管理
/// </summary>
public class CatalogManager(DataAccessContext<Catalog> storeContext, IUserContext userContext, ILogger<CatalogManager> logger) : ManagerBase<Catalog, CatalogUpdateDto, CatalogFilterDto, CatalogItemDto>(storeContext, logger)
{
