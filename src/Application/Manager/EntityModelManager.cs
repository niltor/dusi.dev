...
public class EntityModelManager : DomainManagerBase<EntityModel, EntityModelUpdateDto, EntityModelFilterDto, EntityModelItemDto>, IDomainManager<EntityModel>
{
	private readonly EntityLibraryManager _libraryManager;
	private readonly OpenAIClient openAIClient;

	public EntityModelManager(DataStoreContext storeContext, EntityLibraryManager libraryManager, OpenAIClient openAIClient) : base(storeContext)
	{
