...
public class ThirdNewsManager(DataAccessContext<ThirdNews> storeContext, IUserContext userContext, ILogger<ThirdNewsManager> logger) : ManagerBase<ThirdNews, ThirdNewsUpdateDto, ThirdNewsFilterDto, ThirdNewsItemDto>(storeContext, logger)
{
