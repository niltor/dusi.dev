...
public class EntityMemberManager : DomainManagerBase<EntityMember, EntityMemberUpdateDto, EntityMemberFilterDto, EntityMemberItemDto>, IDomainManager<EntityMember>
{
