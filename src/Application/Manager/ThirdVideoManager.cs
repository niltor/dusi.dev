...
public class ThirdVideoManager(DataAccessContext<ThirdVideo> storeContext, IUserContext userContext, ILogger<ThirdVideoManager> logger) : ManagerBase<ThirdVideo, ThirdVideoUpdateDto, ThirdVideoFilterDto, ThirdVideoItemDto>(storeContext, logger)
{
